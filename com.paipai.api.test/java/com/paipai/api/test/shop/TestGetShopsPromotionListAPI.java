 ...
 * @author kevenzhou
 */
public class TestGetShopsPromotionListAPI extends TestAPIBase {
	@Override
...
//		 this.IP_PORT = "http://172.25.34.81:9001";
	...
	public void testGetShopPromotionList(){
		...
		parameter.addStringParam("sellerUinList", "855000172,855000210");

		try {
			testBase(parameter, "json", "shop", "getShopsPromotionList");
