 ...
 * @author kevenzhou
 */
public class TestGetShopPromotionListAPI extends TestAPIBase {
	@Override
...
//		 this.IP_PORT = "http://172.25.34.81:9001";
	...
	public void testGetShopPromotionList(){
		...
		parameter.addStringParam("sellerUin", "855000210");

		try {
			testBase(parameter, "json", "shop", "getShopPromotionList");
